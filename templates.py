def set_template(args):
    if args.template is None:
        ...
        args.dataset_code = input('Input ml-1m, ml-20m, amazon: ')
    ...
    elif args.template.startswith('train_bertemb'):
        args.mode = 'train'
        ...
        args.dataloader_code = 'bert_embedding'
        batch = 128
        args.train_batch_size = batch
        args.val_batch_size = batch
        args.test_batch_size = batch
        ...
        args.model_code = 'bert_embedding'
        args.model_init_seed = 0
        
        # Path to the pre-trained item embeddings
        args.item_embedding_path = "Data/preprocessed/amazon_min_rating4-min_uc5-min_sc0-splitleave_one_out/item_embeddings.npy"

        args.bert_dropout = 0.1
        args.bert_hidden_units = 1024 # Must match E5 embedding dim
        args.bert_mask_prob = 0.15
        args.bert_max_len = 100
        args.bert_num_blocks = 2
        args.bert_num_heads = 4
